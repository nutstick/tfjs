                ...
                flag_groups = [
                    flag_group(
                        flags = [
                            ...
                            "-isystem",
                            "external/emsdk/emsdk/fastcomp/emscripten/system/lib/libcxxabi/include",
                            "-isystem",
                            "external/emsdk/emsdk/fastcomp/emscripten/system/include/compat",
                            "-isystem",
                            "external/emsdk/emsdk/fastcomp/emscripten/system/include",
                            "-isystem",
                            "external/emsdk/emsdk/fastcomp/emscripten/system/include/SSE",
                            "-isystem",
                            "external/emsdk/emsdk/fastcomp/emscripten/system/include/libc",
                            "-isystem",
                            "external/emsdk/emsdk/fastcomp/emscripten/system/lib/libc/musl/arch/emscripten",
                            "-isystem",
                            "external/emsdk/emsdk/fastcomp/emscripten/system/local/include",
                            "-isystem",
